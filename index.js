...
var Publishable_Key = 'pk_test_51N3AdHF9Mz6wZpcuoFPCleC8V1TVydCizxJzBsWEDmwhNSCL6Kxx2JnH7z2O94Pb7gXo7EzcQONhX81EirphFdwA00Bp26TsXS'
var Secret_Key = 'sk_test_51N3AdHF9Mz6wZpcuXtrIPfBRSUZanAPoeoQeUEZJFqKGEOoIrN7oUPSSyLRtkFTTi9hSkEh0bPkDrzvM36JcOEtC00Uc42ahe6'
...
app.post("/api/v1/send/otp", async function (req, res) {
  ...
  if (true) {
    ...
    let info3 = await transporter.sendMail({
      from: '"SILA PAY" <info@uzet.ae>', // sender address
